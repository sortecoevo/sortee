...
We are pleased to share the 2025 SORTEE Commendation Award recipients (listed in alphabetical order): EcoEvoApps, Flipping the Script, JuliaPhylo, MacaqueNet, MorphoBank, and the Virtual Australian Museum of Palaeontology (VAMP). You can learn more about each project in descriptions below.

### **EcoEvoApps**

**Website**: <https://ecoevoapps.gitlab.io/> 

**About**: Mathematical models are useful tools to study ecological and evolutionary dynamics. These models are often taught in undergraduate classes, but can appear intimidating to students, especially those without much quantitative training. EcoEvoApps addresses this gap with a collection of free Shiny apps and an R package that allow users to interactively explore mathematical models of ecology and evolution. By adjusting parameter values, users can instantaneously visualize the corresponding changes in model dynamics, supplementing other ways of learning these models. The platform currently hosts fourteen apps covering population ecology, species interactions, landscape ecology, and other specialized topics, and the collection continues to grow. Most of the apps are also available in Chinese, Portuguese, Spanish, and Turkish, in addition to English. Designed to lower barriers to quantitative learning, it supports users with diverse linguistic, cultural, and computational backgrounds. EcoEvoApps is a living and evolving project. It is fully open-source and community-driven, always welcoming general feedback, new app suggestions, collaborations in app development, and classroom use by educators and learners worldwide.

  

### **Flipping the Script**

**Website**: Lessons are hosted openly on QUBESHub (<https://qubeshub.org>)

**About**: This project transforms undergraduate biology education by embedding authentic data science training within an Ecology Lab course. Recognizing limited student exposure to big data and R programming, the instructional team created interactive R tutorials using the 'swirl' platform. These custom lessons arewoven into each lab module, allowing students to practice real-world statistical analysis with authentic ecological datasets. The interactive interface provides immediate feedback and adaptive hints, helping students "learn R in R" while reducing coding anxiety. Implemented through a flipped-class model, students complete coding prelabs before class, then build on their scripts during in-lab data analysis. This structure maximizes class time for experimentation and reinforces transparent, reproducible research practices. By independently coding, students see both the creativity and pitfalls of data analysis, fostering appreciation for meticulous scientific documentation. The project has increased student confidence, engagement, and identity as scientists, while also expanding departmental teaching capacity. Graduate and undergraduate TAs can now effectively assist students while gaining programming skills themselves. Ecology Lab enrollment has doubled, and the course now serves as a core course for a new Environmental Science major. The materials are freely available through the NSF-supported QUBES platform, supporting national reform in quantitative biology education.

  

### **JuliaPhylo: a software ecosystem for phylogenetics in Julia**


![](/img/award_juliaph.png)


**Website**: <https://juliaphylo.github.io/JuliaPhyloWebsite/> 

**About**: The JuliaPhylo project grew from small beginnings into an ecosystem of Julia packages for the inference, manipulation, visualization, and use of evolutionary networks to study trait evolution. Evolutionary networks, also referred to as 'phylogenies', include trees (phylogenetic gene/species trees) and phylogenetic networks as well as admixture graphs. Networks can encode hybrid speciation events, gene flow between species, and admixture between populations. We chose the Julia programming language because it is open-source, and combines ease-of-use with speed. JuliaPhylo packages now receive contributions from developers across the research community. JuliaPhylo is modular, with different features and methods living in different packages. Some packages focus on core utilities to manipulate trees and networks, to plot them, or to summarize a sample of phylogenies. Other packages focus on inferring phylogenies. Others focus on evolutionary simulations: simulating gene trees within population / species phylogenies (under the multispecies coalescent), or simulating traits controlled by these genes. Finally, some packages focus on analyzing trait evolution along phylogenies. This modularity, and being open-source, makes it more accessible for potential contributors to join the project and collaborate on implementing new features. This growth is exciting!
...
![](/img/award_macaquenet.png)

**Website**: <https://macaquenet.github.io/>  

**About**: MacaqueNet is a global collaborative community hosting the largest standardised, publicly searchable database of animal social behaviour. It contains data on over 3,000 individual macaques from 61 populations spanning 14 species, contributed by 118 researchers across 58 institutions in 18 countries. This community-driven initiative is dedicated to making data more accessible, standardised, and reusable. Developed to overcome challenges with data sharing, including inconsistent methods hindering standardisation and concerns over misinterpretation, MacaqueNet works with contributors to archive raw data and metadata using well-defined protocols for standardisation, archiving, and sharing. Data sharing follows FAIR (Findable, Accessible, Interoperable, Reusable) principles under community-agreed terms of use. Nearly 700 social networks are centralised and requestable, allowing researchers to conduct large-scale comparative analyses that would be impossible using single or limited populations. Beyond the database, MacaqueNet connects researchers worldwide through biennial symposia, an active website, a Slack workspace, and six-monthly newsletters. It supports early-career scientists and researchers from underrepresented regions, and those without access to long-term datasets. With multiple cross-species projects already using the database, MacaqueNet is helping drive open, inclusive, collaborative science and contributing to greater transparency, reproducibility, and data reuse---efforts that will help strengthen research across behavioural ecology and evolutionary biology. You can sign-in for MacaqueNet's newsletter [here](https://docs.google.com/forms/d/e/1FAIpQLSef2OLRBd0Bd4PcgsASWWF8JEb2ZE%20L90XugA2lqLlRud7qDGQ/viewform).
...
![](/img/award_morphobank.png)

**Website**: <https://www.morphobank.org/> 

**About**: MorphoBank is an open-access, FAIR-aligned research repository designed to support evolutionary research based on phenotypes (morphology), particularly in systematics, cladistics, and phylogenetics. Because phenotype-based research relies on explicitly defined characters and character states, often supported by images and other media, MorphoBank provides purpose-built tools through an integrated web application and database that enable scientists to collect, curate, annotate, and publish datasets in a structured and reusable way. Developed with support from the U.S. National Science Foundation and sustained by institutional and community partners, MorphoBank facilitates the open sharing of peer-reviewed observations as both text and 2D and 3D images. Beyond serving as a repository, MorphoBank enables real-time collaboration among distributed research teams, allowing scientists to jointly build and refine phylogenetic matrices and directly link character statements to supporting media. Dedicated staff curation improves metadata quality and long-term usability, ensuring that datasets remain findable, interpretable, and reusable over time. As of December 12, 2025, MorphoBank hosts 2,043 publicly accessible projects, comprising 1,426 matrices and 211,111 media files, with an additional 2,176 projects in progress that will be released as studies are completed. The platform supports 4,658 scientists and students as active content builders, and more than 21,500 site visitors viewed or downloaded data in the past 30 days. Together, these efforts position MorphoBank as a shared, community-driven infrastructure advancing open, transparent, and reproducible eco-evo science. You can follow MorphoBank's updates on [Bluesky](https://bsky.app/profile/morphobank.bsky.social) and [LinkedIn](https://www.linkedin.com/company/phoenix-bioinformatics/).
...
![](/img/award_VAMP.png)
**Website**: <https://sites.flinders.edu.au/vamp/> 

**About**: VAMP is an online, open access virtual museum dedicated to showcasing Australia's fossil heritage in 3 D. Through VAMP, researchers, educators and the general public can explore high resolution, interactive, downloadable 3D scans of fossil specimens, from some of the earliest complex life to Australia's iconic extinct megafauna. VAMP brings together fossils held in museum collections, many of which are rare or "type specimens" not usually accessible to the public. We are a collaboration led by early and mid career researchers at Flinders University in partnership with institutional partners South Australian Museum (SAM), Western Australian Museum (WAM), and Museum and Art Gallery of the Northern Territory (MAGNT) and others. Using modern scanning technologies (such as CT and micro CT scans, synchrotron/neutron tomography, photogrammetry, LiDAR, and surface scanning) , the project digitises fossils without damaging them. This approach allows detailed study of both external shapes and internal structure, enabling new kinds of research, outreach, teaching, and public engagement. From early Ediacaran life to Pleistocene megafauna, VAMP provides a window into 600 million years of Australian palaeontological heritage, Celebrating digital Australian fossils in 3D and providing a valuable resource for scientists, students, and curious minds alike.   


## **2024**

In 2024, we focused on revising and improving the awards criteria and therefore did not present any awards that year. 
