---
title: 'Discover the Sessions of the SORTEE 2025 Conference (2) 🔍'
author: The SORTEE 2025 Conference Committee
date: "2025-12-08"
summary: We are back one last time with the highlights from the SORTEE 2025 conference! Here you will find an overview of hackathons and unconferences at the SORTEE 2025 conference and other related useful information. 
categories:
  - blog
tags:
  - conference
  - conference2025
banner: img/SORTEE_conference_logo.png
---

{{< toc >}}

Final post about the SORTEE 2025 conference! This week, we—the conference committee—are excited to share an overview of the inspiring hackathons[^1] and unconferences[^2] that took place during the event. Note that three hackathon projects are still open to new collaborators. Check out our [first blog post](https://sortee.org/blog/2025/11/12/2025_highlights_from_the_sortee_conference/) and [second blog post](https://sortee.org/blog/2025/12/01/2025-sortee-conference-sessions-1/) if you missed them for more insights about the event. 

[^1]: Hackathons bring researchers together to produce some form of public output based on the participants’ collective work, such as producing a manual / guidelines / article, developing software, or creating a protocol. The time available during the conference usually isn’t enough to complete the project but allows teams to form and get work started. See examples at <https://sortee.org/collaborations/">

[^2]: Unconferences are facilitated discussions about current or prospective research practices and tools that aim to improve the reliability, transparency and openness of science
...
➡️ Want to help promote SORTEE? You can dive into the hackathon activities by finding the hackathon slides and the templates (for emails and social media messages) on OSF [here](https://osf.io/f8e6c/), next to the hackathon output on how to pitch SORTEE to others. Also check out the LinkedIn video tutorial below. 

<div align=”center”><iframe width="560" height="315" src="https://www.youtube.com/embed/Twa97HfiUdI?si=bvSzVUR1saZYILS0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
...
{{< centered-figure src="/img/Conf2025_reprohack_logo.png" width="200px" alt="ReproHack logo" >}} 
...
➡️ Ever thought about joining or organising a reprohack session? Go to the [ReproHack website](https://www.reprohack.org/) and check out the [hackathon material](https://osf.io/gfk8r/). 
...
{{< centered-figure src="/img/Conf2025_Hackathon 4.png" width="500px" alt="Mechanistic model explanation" >}} 

&nbsp;

➡️ Want to join the project? Fill in this [form](https://forms.gle/cqxfngSzyevgpfRA6). Slides are available at <https://osf.io/qtfrm/>.

## Let’s expand the dataset of learned societies in ecology and evolutionary biology
Malgorzata (Losia) Lagisz and Alfredo Sánchez-Tójar led this hackathon to gather collaborators on a project to expand a dataset of learned societies[^1]? in ecology and evolution that Losia and collaborators have developed. This dataset has already supported three published articles and two ongoing projects (see Figure below and <https://sortee.org/collaborations/>). 

[^1]: Do you know what a learned society is? It is a professional organisation that brings researchers together to promote research in their field and to support each other.

{{< centered-figure src="/img/Conf2025_Hackathon 5.png" width="500px" alt="Uses of the dataset on learned societies" >}} 
...
{{< centered-figure src="/img/Conf2025_Unconference 5.PNG" width="350px" alt="Measure how LMMs generate concerns and excitement" >}} 
...
{{< centered-figure src="/img/Conf2025_Unconference 6.PNG" width="500px" alt="Joke about causal inference" >}} 


&nbsp;


➡️ Let’s all benefit from Directed Acyclic Graphs and start using them in our research. In other words, let’s DAG in! Access the unconference slides at <https://osf.io/awkph/>
 and feel free to email us at conference@sortee.org if you’d like to get in touch with Apu and Mirjam.

## How to think about hypothesis testing in ecology?
What matters more: statistical significance or ecological relevance?  In this unconference, the session facilitators (Gabriela Xavier-Quintais, Daniel Lakens, Tiago A. Marques) made participants quickly realise that while *statistical significance* is easy to determine, *ecological relevance* is much harder to define. Yet, ecological relevance is what really matters when interpreting results in ecology. The following discussion was around whether we should keep testing nil null hypotheses, or instead test against meaningful, ecologically relevant values. If the second is the case, how do we decide what those values are and who gets to determine them? Some suggested using frameworks similar to medicine’s “minimal clinically important difference”. The discussion also touched on the possible constraints in the field of ecology on the use of hypothesis testing and what other possible methodological approaches could be used in this area of knowledge. The group debated how researcher education and statistical thinking could evolve to better connect numbers with ecological meaning. 
This unconference wasn’t just technical, but also philosophical! An effort was made to discuss the concept of “ecological relevance” -  a concept not yet defined in the literature. Despite its complexity, the discussion was passionate and never felt exhaustive. 

➡️ Want to learn more? Access a summary of what was discussed and the unconference slides at <https://osf.io/qk7s5/>. 
