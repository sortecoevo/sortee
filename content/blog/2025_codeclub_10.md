---
title: 'SORTEE Code Club Unconference: How to start your own code club'
author: "Cecilia Baldoni, Saoirse Kelleher, Natalie van Dis, Corné de Groot"
date: "2025-10-28"
summary: "The authors debriefs about the 2025 SORTEE Conference, and the Unconference Session 5: How to start your own code club"
categories:
- blog
tags:
- code club
...
From this great collaborative experience, we created an [open guide](https://sortee.github.io/start-your-codeclub-guide/). It includes everything we discussed during the Unconference: session formats, strategies for different scenarios, practical tips from real facilitators, and list of resources. More importantly, it's built for contribution, meaning that [`pull requests` and `issues` are welcome](https://github.com/SORTEE/start-your-codeclub-guide), because code clubs exist everywhere and this guide should reflect that diversity.
...
Check out the [\[Code Club Guide\]](https://sortee.github.io/start-your-codeclub-guide/) and contribute on [\[GitHub\]](https://github.com/SORTEE/start-your-codeclub-guide)!

**What’s next?**  
The next Code Club meeting will be **on Tuesday, November 18th** (zoom link will be posted on [SORTEE’s Slack](https://www.sortee.org/join/)).
