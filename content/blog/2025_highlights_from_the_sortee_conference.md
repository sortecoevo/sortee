---
title: 'Highlights from the SORTEE 2025 Conference ✨'
author: The SORTEE 2025 Conference Committee
date: "2025-11-12"
summary: Catch up on the highlights from the SORTEE 2025 conference! We will explore what exactly happened, get to see the attendance statistics and fun facts, and discover how successful the conference was in the eyes of the attendees, as well as some behind-the-scenes facts from the conference committee. Stay tuned for more posts from the conference committee! 
...
Attendees were far from passive spectators — they participated in lively unconference[^1] discussions, started collaborative projects during hackathons[^2], and learnt new practices in workshops. Additionally, participants were inspired by the plenary talks given by Israel Borokini and Simine Vazire, while newcomers were introduced to open science with dedicated sessions. Attendees were also fortunate to be the first to discover the winners of the [SORTEE 2025 Commendation Award](https://sortee.org/awards/) during the conference closing remarks! 

[^1]: Unconferences are facilitated discussions about current or prospective research practices and tools that aim to improve the reliability, transparency and openness of science

[^2]: Hackathons bring researchers together to produce some form of public output based on the participants’ collective work, such as producing a manual / guidelines / article, developing software, or creating a protocol. The time available during the conference usually isn’t enough to complete the project but allows teams to form and get work started. See examples at <https://sortee.org/collaborations/">
...
We are looking forward to seeing you at the next [SORTEE conference](https://sortee.org/upcoming/)! Subscribe to our [mailing list](https://sortee-conference.myflodesk.com/subscribe) to receive updates – we send a maximum of 8 emails a year.
...
{{< centered-figure src="/img/Conf2025_Final world map registrants.png" width="800px" alt="Countries of registrants on a world map" caption="World map showing the countries of registrants at the SORTEE 2025 conference">}} 
...
{{< centered-figure src="/img/Conf2025_Results feedback form (1).png" width="800px" alt="Countries of registrants on a world map" caption="Results from the feedback form about the SORTEE 2025 conference">}} 

**In terms of logistics, we had:**
+ 1 Zoom link for the whole conference
+ 1 [information pack](https://doi.org/10.17605/OSF.IO/CDS6N) with everything you need to know about the conference
+ 1 [program app](https://conf-sortee.shinyapps.io/2025-program-app/) to convert the schedule into your own time zone
+ 0 technical issues 
...
{{< centered-figure src="/img/Conf2025_Results feedback form (2).png" width="800px" alt="Conference feedback form results" caption="Results from the feedback form about the SORTEE 2025 conference">}} 
...
🙏 If you encountered any barriers to attending, or have ideas for improving accessibility and diversity, please fill in this [anonymous form](https://forms.gle/CuoK9KqH5yXaLzRX7). We would really appreciate your input. Learn more about SORTEE conference accessibility at <https://sortee.org/upcoming/>.
