...
The 2026 SORTEE conference will run continuously for 24 hours from **13 October** to **14 October** to cover all time zones. The conference will be **FREE** for SORTEE members, and ranging from \$0 to \$60 for non-SORTEE members.[ Become a member!](https://www.sortee.org/join/) 

To join the mailing list and receive conference updates, click [here](https://alluring-acorn-871.myflodesk.com/s4v8w89s35). We send a maximum of 8 emails a year.

The conference is a forum to **discuss** and **develop ideas**, while also exploring **current practices** for advancing research in fields related to open science in ecology and evolutionary biology. 
...
To have an idea of what a SORTEE conference looks like, check out the last SORTEE conference program [here](https://conf-sortee.shinyapps.io/2025-program-app/) and the summary of previous conferences at <https://www.sortee.org/past.>[ ](https://www.sortee.org/past)

## **Content submissions will soon open on this page**

To have a great conference, we need motivating events and facilitators! We invite anyone interested in facilitating an unconference, a hackathon or a workshop to submit their content. You don't have to be a SORTEE member. Content submissions will open soon on this web page. 

## **Contact**

Don't hesitate to contact us at [conference\@sortee.org](mailto:conference@sortee.org) if you have any questions.
...
If you have any questions or suggestions regarding accessibility and diversity at SORTEE conferences, or if you face any barriers to attending, please contact us at [conference\@sortee.org](mailto:conference@sortee.org) or complete this [anonymous accessibility form](https://forms.gle/LGGznsTzsMEsx7Hu5). Responses are shared only with the SORTEE conference committee and board of directors.
...
Take a look at the[ SORTEE 2025 conference blog posts](https://sortee.org/tags/conference2025/) to get a clearer idea of what a SORTEE conference is all about. You can also find summaries of past conferences at <https://www.sortee.org/past>.
