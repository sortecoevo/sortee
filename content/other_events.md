...
**Type:** Webinar\
**Date and Time:** July 7, 2026 at 08:00 UTC\
...
### **Title:** *The Risks and Rewards of Large Language Models in (open) Scientific Research*

**Presenter:** Dr. Tanya Strydom\
**Type:** Webinar\
**Timezone(s):** Europe/Australasia\
**Duration:** 60 min\
...
### **Title:** *Quarto: Reproducible Analyses in R and Python*

**Presenter:** Saoirse Kelleher / Cecilia Baldoni\
**Type:** Webinar\
**Timezone(s):** Europe/Australasia\
**Duration:** 60 min\
**Summary:** Quarto is an open-source scientific and technical publishing system from Posit that extends RMarkdown to produce reproducible documents, presentations, dashboards, and websites from R, Python, and other languages. This webinar will introduce the basics of Quarto, show how it can support reproducible research workflows, and include a short tutorial on writing analyses in Quarto to help you get started using it in your own work.
